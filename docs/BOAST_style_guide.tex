...
\KeywordTok{dashboardHeader}\NormalTok{(}
      ...
      \DataTypeTok{titleWidth =} \StringTok{"300"}\NormalTok{,}
...
We highly recommend using the \href{https://wave.webaim.org/}{WAVE Web Accessibility Evaluation Tool}. If you use Firefox or Chrome, we recommend that you install the \href{https://wave.webaim.org/extension/}{WAVE Browser Extension} as this will give you a quick way to test your App's accessbility.
