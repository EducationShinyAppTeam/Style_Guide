...
\hypertarget{basicsb}{%
\chapter{The Basics}\label{basicsb}}

Before you get too far into the Style Guide, we would like for you to take a moment and ensure that you have the following tools at your disposal.

\hypertarget{checklistb}{%
\section{Getting Started Checklist}\label{checklistb}}
...
\end{Shaded}
\item
  A copy of the Sample App (\protect\hyperlink{sample-appb}{see below})
\end{enumerate}

\hypertarget{boastutils-package-1}{%
\section{\texorpdfstring{\texttt{boastUtils} Package}{boastUtils Package}}\label{boastutils-package-1}}
...
\hypertarget{sample-app-1}{%
\section{Sample App}\label{sample-app-1}}
...
\hypertarget{direct-download-1}{%
\subsection{Direct Download}\label{direct-download-1}}
...
\hypertarget{command-line-1}{%
\subsection{Command Line}\label{command-line-1}}
...
\hypertarget{rstudio-projectb}{%
\subsection{RStudio Project}\label{rstudio-projectb}}
