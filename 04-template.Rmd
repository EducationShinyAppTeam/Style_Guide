...
+ ![stable](https://img.shields.io/badge/lifecycle-stable-brightgreen) An app is considered stable when we've reached a point where there are no bugs left to fix, only minimal improvements can be made, and adding new features is not necessary a priority. This is where we want most apps to end up.
    - `![stable](https://img.shields.io/badge/lifecycle-stable-brightgreen)`
<br /> <br />
+ ![maturing](https://img.shields.io/badge/lifecycle-maturing-blue) A maturing app is one that is nearing stability but we're still in the process of fine tuning or adding new features to the app.
