...
Now that you've gotten your computer set up and you've made yourself a workflow, you're nearly ready to begin working on apps for BOAST. This Guide is the primary key to getting start but the BOAST Template is the secondary key to your success. 
...
This is where you'll do the vast majority of your work. We will not spend too much time describing the ins and outs of this file. However, we do want to mention the five components to any BOAST app.R file:
...
+ __Lifecycle:__ you'll put the one word mention of the lifecycle; see [below](#lifecycle) for the words to put here.
