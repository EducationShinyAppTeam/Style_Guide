...
knitr::include_graphics("images/planSketch1.jpg")
```
...
knitr::include_graphics("images/planSketch2-Info.jpg")
```
...
knitr::include_graphics("images/planSketch5-Challenge.jpg")
```
