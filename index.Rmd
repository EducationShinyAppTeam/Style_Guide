...
A key exception to the above deals with coding and app performance, but these are secondary to sound educational and pedagogical reasons. We strive for our Shiny apps to not become *shiny*.
