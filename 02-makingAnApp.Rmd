...
*Note: We've written this step to center on making a new app. However, you can also think of this as identifying what an existing app's goals are. Thus, keep both new and existing apps in mind as you read this section.*
...
Don't feel like you have to details down to the nanoscale. As you continue developing and talking with people, you'll start adding in more details.
...
In both workflows of [Chapter \@ref(workflow)](#workflow), there was the following phrase: ON PAPER. This step here is where you really do need to take this phrase seriously.
