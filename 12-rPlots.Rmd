...
```{r logoCodec, echo=TRUE, eval=FALSE}
...
```{r psuLogoc, echo=TRUE, eval=FALSE}
dashboardPage(
  skin = "blue",
  dashboardHeader(
    title = "title",
...
```{r paraStyle1c, echo=TRUE, eval=FALSE}
p(
...
```{r plotText1c, echo=TRUE, eval=FALSE}
...
```{r axesControl1c, echo=TRUE, eval=FALSE}
...
### Color and Plots in `R` {#colorPlotsc}
...
```{r customPalettesc, echo=TRUE, eval=FALSE}
...
```{r boastPalettec, fig.cap="The Boast Palette", fig.align='center', fig.width=7, fig.height=1.25, echo=FALSE}
boastPalette <- c("#0072B2","#D55E00","#009E73","#CE77A8",
    "#000000","#E69F00","#999999","#56B4E9","#CC79A7")
...
```{r psuPalettec, fig.cap="The PSU Palette", fig.align='center', fig.width=7, fig.height=1.25, echo=FALSE}
psuPalette <- c("#1E407C","#BC204B","#3EA39E","#E98300",
    "#999999","#AC8DCE","#F2665E","#99CC00")
...
```{r examplePalettec, echo=TRUE, eval=FALSE}
...
```{r installDTc, echo=TRUE, eval=FALSE}
install.packages("DT")
...
```{r dtUICode1c, echo=TRUE, eval=FALSE}
# [code omitted]
...
```{r dtServerCode1c, echo=TRUE, eval=FALSE}
# [code omitted]
...
```{r dtSummary1Setupc, echo=TRUE, eval=TRUE}
...
```{r dtSummary1Shinyc, echo=TRUE, eval=FALSE}
# Make the Table
...
```{r dtSummary1Targetc, echo=FALSE, eval=FALSE}
DT::datatable(
  data = penStats,
  caption = "Descriptive Stats for Palmer Penguins", 
  style = "bootstrap4", 
...
```{r dtSummary2Setupc, echo=TRUE, eval=TRUE}
library(palmerpenguins)
library(psych)
library(DT)
library(tibble)
...
```{r dtSummary2Shinyc, echo=TRUE, eval=FALSE}
# Make the Table
...
```{r dtSummary2Targetc, echo=FALSE, eval=FALSE}
DT::datatable(
  data = anovaPen,
...
```{r imageEx1c, echo=TRUE, eval=FALSE}
#[code omitted]
div(align = "right",
    img(src = "check.PNG",
...
```{r imageEx2c, echo=TRUE, eval=FALSE}
#[code omitted]
