...
When considering the Visual Appearance of your App, there are two major areas of consideration: the [Layout](#layoutb) and what we refer to as [Design Styling](#designStyleb). Each of these will be handled in turn. Keep in mind that these two aspects are inter-related and have significant cross-over.
...
A good number of the elements of the layout will have a direct consequence on your coding. For instance, in the section on [Organizing Your Code](#orgCodeb), you saw that the UI definition needed to come before the Server definition. This section defines additional organizational structure to your code as it pertains to the layout of your App.
...
```{r makeDashboard1b, echo=TRUE, eval=FALSE}
# Required package
...
### Color in the User Interface {#colorUIb}
...
```{r bluePaletteb, fig.cap="The Blue Palette", fig.align='center', fig.width=6, fig.height=2, echo=FALSE}
ggplot2::ggplot() +
  ggplot2::geom_rect(
    mapping = ggplot2::aes(
      xmin = 0, xmax = 2,
...
```{r blueAction1b, fig.align='center', fig.width=6, fig.height=4, echo=FALSE, fig.cap="Overview Page Using the Blue Palette"}
knitr::include_graphics("images/colorThemes/blueOverview.png")
```

```{r blueAction2b, fig.align='center', fig.width=6, fig.height=4, echo=FALSE, fig.cap="Collapsible Boxes Using the Blue Palette"}
knitr::include_graphics("images/colorThemes/blueCollapse.png")
```

```{r blueAction3b, fig.align='center', echo=FALSE, fig.cap="Sliders Using the Blue Palette"}
...
```{r greenPaletteb, fig.cap="The Green Palette", fig.align='center', fig.width=6, fig.height=2, echo=FALSE}
ggplot2::ggplot() +
  ggplot2::geom_rect(
    mapping = ggplot2::aes(
      xmin = 0, xmax = 2,
...
```{r greenAction1b, fig.align='center', fig.width=6, fig.height=4, echo=FALSE, fig.cap="Overview Page Using the Green Palette"}
knitr::include_graphics("images/colorThemes/greenOverview.png")
```

```{r greenAction2b, fig.align='center', fig.width=6, fig.height=4, echo=FALSE, fig.cap="Collapsible Boxes Using the Green Palette"}
knitr::include_graphics("images/colorThemes/greenCollapse.png")
```

```{r greenAction3b, fig.align='center', echo=FALSE, fig.cap="Sliders Using the Green Palette"}
...
```{r purplePaletteb, fig.cap="The Purple Palette", fig.align='center', fig.width=6, fig.height=2, echo=FALSE}
ggplot2::ggplot() +
  ggplot2::geom_rect(
    mapping = ggplot2::aes(
      xmin = 0, xmax = 2,
...
```{r purpleAction1b, fig.align='center', fig.width=6, fig.height=4, echo=FALSE, fig.cap="Overview Page Using the Purple Palette"}
knitr::include_graphics("images/colorThemes/purpleOverview.png")
```

```{r purpleAction2b, fig.align='center', fig.width=6, fig.height=4, echo=FALSE, fig.cap="Collapsible Boxes Using the Purple Palette"}
knitr::include_graphics("images/colorThemes/purpleCollapse.png")
```

```{r purpleAction3b, fig.align='center', echo=FALSE, fig.cap="Sliders Using the Purple Palette"}
...
```{r blackPaletteb, fig.cap="The 'Black' Palette", fig.align='center', fig.width=6, fig.height=2, echo=FALSE}
ggplot2::ggplot() +
  ggplot2::geom_rect(
    mapping = ggplot2::aes(
      xmin = 0, xmax = 2,
...
```{r blackAction1b, fig.align='center', fig.width=6, fig.height=4, echo=FALSE, fig.cap="Overview Page Using the 'Black' Palette"}
knitr::include_graphics("images/colorThemes/blackOverview.png")
```

```{r blackAction2b, fig.align='center', fig.width=6, fig.height=4, echo=FALSE, fig.cap="Collapsible Boxes Using the 'Black' Palette"}
knitr::include_graphics("images/colorThemes/blackCollapse.png")
```

```{r blackAction3b, fig.align='center', echo=FALSE, fig.cap="Sliders Using the 'Black' Palette"}
...
```{r yellowPaletteb, fig.cap="The Yellow Palette", fig.align='center', fig.width=6, fig.height=2, echo=FALSE}
ggplot2::ggplot() +
  ggplot2::geom_rect(
    mapping = ggplot2::aes(
      xmin = 0, xmax = 2,
...
```{r yellowAction1b, fig.align='center', fig.width=6, fig.height=4, echo=FALSE, fig.cap="Overview Page Using the Yellow Palette"}
knitr::include_graphics("images/colorThemes/yellowOverview.png")
```

```{r yellowAction2b, fig.align='center', fig.width=6, fig.height=4, echo=FALSE, fig.cap="Collapsible Boxes Using the Yellow Palette"}
knitr::include_graphics("images/colorThemes/yellowCollapse.png")
```

```{r yellowAction3b, fig.align='center', echo=FALSE, fig.cap="Sliders Using the Yellow Palette"}
...
```{r redPaletteb, fig.cap="The Red Palette", fig.align='center', fig.width=6, fig.height=2, echo=FALSE}
ggplot2::ggplot() +
  ggplot2::geom_rect(
    mapping = ggplot2::aes(
      xmin = 0, xmax = 2,
...
```{r redAction1b, fig.align='center', fig.width=6, fig.height=4, echo=FALSE, fig.cap="Overview Page Using the Red Palette"}
knitr::include_graphics("images/colorThemes/redOverview.png")
```

```{r redAction2b, fig.align='center', fig.width=6, fig.height=4, echo=FALSE, fig.cap="Collapsible Boxes Using the Red Palette"}
knitr::include_graphics("images/colorThemes/redCollapse.png")
```

```{r redAction3b, fig.align='center', echo=FALSE, fig.cap="Sliders Using the Red Palette"}

knitr::include_graphics("images/colorThemes/redSliders.png", dpi= NA)
```

### Current Chapter Color Assignments {#chapterColorb}
...
```{r makeHeader1b, echo=TRUE, eval=FALSE}
# [omitted code]
dashboardHeader(
...
```{r infoServerb, echo=TRUE, eval=FALSE}
# Required Packages
...
```{r makeSidebar1b, echo=TRUE, eval=FALSE}
# [omitted code]
dashboardSidebar(
  width = 250,
  sidebarMenu(
...
```{r makeBody1b, echo=TRUE, eval=FALSE}
# [code omitted]
dashboardBody(
  tabItems(
    tabItem(
...
```{r makeOverview1b, echo=TRUE, eval=FALSE}
# Required Package
library(shinyBS)
...
```{r movementButton1b, echo=TRUE, eval=FALSE}
...
```{r actionButton1b, echo=TRUE, eval=FALSE}
# In the UI Section
actionButton(
  inputId = "ap1",
...
```{r textLinkEx1b, echo=TRUE, eval=FALSE}
# [omitted code]
...
```{r makePrereq1b, echo=TRUE, eval=FALSE}
# [code omitted]
tabItem(
...
```{r makeRefb, echo=TRUE, eval=FALSE}
# In the UI Section
# [code omitted]
tabItem(
  tabName = "References",
...
### Tabs Inside the Body {#innerTabsb}
...
### Collapsible Boxes {#collapsibleb}
