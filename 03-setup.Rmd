...
1. Ensure that you have all of necessary accounts and if not, contact Neil ([njh5464](mailto:njh5464@psu.edu)).  
    ...
    c. [BOAST:SU23-Discussions Channel](https://teams.microsoft.com/l/channel/19%3aa4d06b7dceab41d6a219c43b192f9ce6%40thread.skype/SU23-Discussions?groupId=a83c9d1b-6bcc-46f4-aa25-82b2fad862ec&tenantId=7cf48d45-3ddb-4389-a9c1-c115526eb52e) in Microsoft Teams (tied to your PSU AccessID)
2. Ensure that you have all of the required software  
    a. [`R` (version 4.3.0 minimum)](https://cran.r-project.org/) 
    ...
    b. [RStudio Desktop (version 2023.03.0 Build 386 or higher; most current version preferred)](https://posit.co/download/rstudio-desktop/)
...
install.packages(
    pkgs = c("devtools", "shiny", "shinydashboard", "shinyBS", 
              "shinyWidgets", "devtools", "ggplot2", "tidyverse")
)
```
