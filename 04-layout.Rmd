...
+ Overview -- tachometer-alt (formerly called dashboard), `r fontawesome::fa(name = "fas fa-tachometer-alt", height = 25)` 
+ Prerequisites -- book, `r fontawesome::fa(name = "fas fa-book", height = 25)`
+ Explore Tabs -- wpexplorer, `r fontawesome::fa(name = "fab fa-wpexplorer", height = 25)`
+ Challenge Tabs -- cogs (formerly called gears), `r fontawesome::fa(name = "fas fa-cogs", height = 25)`  
+ Game Tabs -- gamepad, `r fontawesome::fa(name = "fas fa-gamepad", height = 25)`
+ References -- leanpub, `r fontawesome::fa(name = "fab fa-leanpub", height = 25)`
...
+ Exploration/Explore Tabs, `r fontawesome::fa(name = "fab fa-wpexplorer", height = 25)`
...
+ Challenge Tabs, `r fontawesome::fa(name = "fas fa-cogs", height = 25)`
...
+ Game Tabs, `r fontawesome::fa(name = "fas fa-gamepad", height = 25)`
...
The icon for this Tab must be "leanpub", `r fontawesome::fa(name = "fab fa-leanpub", height = 25)`.
...
+ A "Prerequisites" button will use the "book" icon, `r fontawesome::fa(name = "fas fa-book", height = 25)`
+ All other tab buttons (labels ending with "!") will use the "bolt" icon, `r fontawesome::fa(name = "fas fa-bolt", height = 25)`
+ A download button will use the "cloud-download-alt" icon, `r fontawesome::fa(name = "fas fa-cloud-download-alt", height = 25)`
...
```{r marks, fig.align='center', echo=FALSE, fig.cap="Correct and Incorrect Marks", fig.show='hold'}
